                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 md:p-8">
                  <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-center">
                    ...
                    <div className="hidden sm:flex flex-shrink-0 mx-auto sm:mx-0">
                      <div className="w-20 h-32 sm:w-32 sm:h-48 md:w-40 md:h-60 relative overflow-hidden shadow-lg bg-surface-elevated">
                        {getPosterUrl() ? (
                          <Image
                            src={getPosterUrl()!}
                      ...
                      <div className="flex flex-wrap justify-center sm:justify-start gap-2 sm:gap-3">
                        ...
                        {(item.type === 'movie' || item.type === 'tvshow') && omdbData?.imdbId && (
                          <motion.a
                            ...
                            className="flex items-center gap-2 px-3 sm:px-4 py-2 bg-[#7B5BF5] hover:bg-[#6344e2] text-white rounded-lg transition-colors font-medium text-sm sm:text-base"
                        ...
                        {item.type === 'book' && (
                          <motion.a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center gap-2 px-3 sm:px-4 py-2 bg-yellow-400 hover:bg-yellow-500 text-black rounded-lg transition-colors font-medium text-sm sm:text-base"
                            variants={buttonVariants}
                            custom={1}
                            whileHover="hover"
                            whileTap="tap"
                        ...
                        {(item.type === 'movie' || item.type === 'tvshow') && getTrailerUrl() && (
                          <motion.button
                            ...
                            className="flex items-center gap-2 px-3 sm:px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg transition-colors font-medium text-sm sm:text-base"
                            variants={buttonVariants}
                            custom={2}
                            whileHover="hover"
                            whileTap="tap"
                        ...
                        {/* Save Button */}
                        <motion.button 
                          className="flex items-center gap-2 px-3 sm:px-4 py-2 bg-primary text-white rounded-lg hover:bg-blue-800 transition-colors font-medium text-sm sm:text-base"
                          variants={buttonVariants}
                          custom={3}
                          whileHover="hover"
                          whileTap="tap"
                        ...
                        {/* Watched/Read Button */}
                        <motion.button 
                          className="flex items-center gap-2 px-3 sm:px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-colors font-medium text-sm sm:text-base"
                          variants={buttonVariants}
                          custom={4}
                          whileHover="hover"
                          whileTap="tap"
                        >
                          ...
                          <span className="hidden sm:inline">{item.type === 'book' ? 'Mark as Read' : 'Mark as Watched'}</span>
                        </motion.button>
                        ...
                        {getExternalLink() && (
                          <motion.a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center gap-2 px-3 sm:px-4 py-2 bg-gray-600 hover:bg-gray-800 text-white rounded-lg transition-colors text-sm sm:text-base"
                            variants={buttonVariants}
                            custom={5}
                            whileHover="hover"
                            whileTap="tap"
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
                      {getCast().map((actor) => (
                        <div key={actor.id} className="text-center">
                          <div className="w-16 h-16 sm:w-20 sm:h-20 relative overflow-hidden rounded-full bg-surface-elevated mx-auto mb-2">
                            {actor.profile_path ? (
                              <Image
                ...
                {!isLoading && (item.type === 'movie' || item.type === 'tvshow') && getDirectorOrCreator() && (
                  <div>
                    ...
                    <div className="flex items-center gap-3">
                      <div className="w-12 h-12 relative overflow-hidden rounded-full bg-surface-elevated">
